        ...
        <div className="footer-column footer-about">
          ...
          <address className="footer-contact" aria-label="Coordonnées">
            <div className="contact-item">
              ...
              <a href="mailto:email@sipci.org" className="email-link">email@sipci.org</a>
            </div>
            ...
            <div className="contact-item">
              ...
              <a href="tel:+2250704959542" className="phone-dark">+2250704959542</a>
            </div>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          <div className="footer-social" aria-label="Réseaux sociaux">
            ...
            <a href="mailto:email@sipci.org" className="social-link email-link" aria-label="Email">
          ...
          <div className="footer-phones" aria-hidden="false">
            <a href="tel:+2252520001969" className="phone-link">+225 25 20 00 19 69</a>
            <a href="tel:+2250584786229" className="phone-link">+225 05 84 78 62 29</a>
            <a href="tel:+2250704959542" className="phone-link">+225 07 04 95 95 42</a>
            <a href="tel:+2250706591183" className="phone-link">+225 07 06 59 11 83</a>
          </div>
        </div>
      </div>
